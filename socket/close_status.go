...
var Normal = CloseStatus{Code: 1000, Reason: ""}
...
var GoingAway = CloseStatus{Code: 1001, Reason: ""}

// ProtocolError - Code 1002 indicates that an endpoint is terminating the connection due to a protocol error.
var ProtocolError = CloseStatus{Code: 1002, Reason: ""}

// NotAcceptable - Code 1003 indicates that an endpoint is terminating the connection because it has received a type of data
// it cannot accept (e.g., an endpoint that understands only text data MAY send this if it receives a binary message).
var NotAcceptable = CloseStatus{Code: 1003, Reason: ""}
...
var NoStatusCode = CloseStatus{Code: 1004, Reason: ""}
